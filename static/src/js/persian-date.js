...
module.exports = {
    ...
    persian: {
        months: ['Hamal', 'Sawer', 'Jawza', 'Saratan', 'Asad', 'Sonbula', 'Meyzan', 'Aqrab', 'Qaws', 'Jadi', 'Dalwa', 'Hoot'],
        monthsShort: ['Ham', 'Saw', 'Jaw', 'Sar', 'Asa', 'Son', 'Mez', 'Aqr', 'Qws', 'Jad', 'Dal', 'Hot'],
...
module.exports = {
    gregorian: {
        months: 'جنوری_فبروری_مارچ_اپریل_می_جون_جولای_آگست_سپتمبر_اکتوبر_نوامبر_دسامبر'.split('_'),
        monthsShort: 'جنوری_فبروری_مارچ_اپریل_می_جون_جولای_آگست_سپتمبر_اکتوبر_نوامبر_دسامبر'.split('_'),
